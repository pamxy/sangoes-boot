package com.sangoes.boot.uc.generator;
 ...
 *
 * @author jerrychir
 * @date 2018/10/29 10:13 AM
 */
public class MysqlGernerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/sangoes-uc";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("jerrychir");
        gc.setOpen(false);
        gc.setSwagger2(true);
        ...
        dsc.setUsername("sangoes");
        dsc.setPassword("Sangoes123456");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.sangoes.boot.uc.modules");
